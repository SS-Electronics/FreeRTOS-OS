...
#error "HSE_VALUE not defined! Check xxx_hal_conf"
#endif

#if !defined  (HSI_VALUE)
#error "HSI_VALUE not defined! Check xxx_hal_conf"
#endif
...
/************************************************************
 *  Following vector table addresses must be defined in line with linker
 *  configuration.
 * 
...
/************************************************************
 * If external ram selected then init this function to set the RAM 
 ***********************************************************/
...
/************************************************************
 SystemCoreClockUpdate(): Updates the variable SystemCoreClock 
                          and must
  *                       be called whenever the core 
                          clock is changed during program
                          execution.
 * 
 ***********************************************************/
...
Setup the external memory controller.
  ...
  *         This function configures the external memories
  *         (SRAM/SDRAM)
