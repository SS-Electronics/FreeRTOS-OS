...
│   board_config.c + board_device_ids.h                        │
│   Peripheral descriptor tables · Callback registration API   │
└───────────────────────────────┬──────────────────────────────┘
                                │
┌───────────────────────────────▼──────────────────────────────┐
...
- `boards/<board>/board_config.c` — peripheral descriptor tables, clock-enable wrappers, callback tables
...
make board-gen                          # regenerates board_config.c and board_device_ids.h
...
| File | Contents |
|------|----------|
| `boards/my_board/board_config.c` | Peripheral descriptor tables, callback tables, board API |
| `include/board/board_device_ids.h` | `#define UART_DEBUG 0`, `#define BOARD_UART_COUNT 2`, … |

> `board_device_ids.h` drives all driver array sizes — never edit it manually.
